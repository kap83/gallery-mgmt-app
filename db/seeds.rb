...
Exhibition.create(id: 3, title: 'Animals', gallery: 'A', start_date: '2024-10-01', end_date: '2025-06-30', user_id: 1 )
Exhibition.create(id: 4, title: 'Women in Art', gallery: 'B', start_date: '2024-02-13', end_date: '2024-09-01', user_id: 2 )
...
art5 = Artwork.create(title: 'Tea', medium: 'oil on canvas', artist_id: 2, exhibition_id: 4)
art6 = Artwork.create(title: 'Woman Bathing', medium: 'color aquatint, with drypoint from three plates, on off-white laid paper', artist_id: 2, exhibition_id: 4)
art7 = Artwork.create(title: "The Child's Bath", medium: 'oil on canvas', artist_id: 2, exhibition_id: 4)
art8 = Artwork.create(title: "Blue Horses", medium: 'oil on canvas', artist_id: 3, exhibition_id: 3)
art9 = Artwork.create(title: "Yellow Cow", medium: 'oil on canvas', artist_id: 3, exhibition_id: 3)
art10 = Artwork.create(title: "Tiger", medium: 'color woodcut print on paper', artist_id: 3)
